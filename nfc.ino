...
and an Arduino Uno (now modified to work with the photon by nick).  The BM019 is a module that
...
void setup() {
    ...
    digitalWrite(IRQPin, HIGH); // Wake up pulse wake me up inside cant wake up
